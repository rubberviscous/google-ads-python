...
placements = [
    "UCjX1zblsBRzf2p0CmtHIL6A",
    "UCFDu6ui05Yc3Ub-Rjmlmidg"
]
...
def main(client, customer_id, campaign_id):
    ...
    shared_set.name.value = 'API Placement exclusion list - %s' % uuid.uuid4()
    shared_set.type = client.get_type('SharedSetTypeEnum',
                                      version='v3').NEGATIVE_PLACEMENTS
    ...
    for placement in placements:
        ...
        #                                           version='v3').BROAD
        placement_info = shared_criterion.youtube_channel
        placement_info.channel_id.value = placement
